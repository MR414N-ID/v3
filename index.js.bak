...
banChats = true
offline = false
targetpc = '6285717118145'
owner = '6285717118145' //6285717118145
fake = '*𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 𝚇𝙸𝙶𝙰ʹさ*'
simbol = '⭘'
numbernye = '0'
waktu = '-'
alasan = '-'
...
module.exports = hexa = async (hexa, mek) => {
	try {
		...
		mess = {
			wait: 'LOADING OM',
			success: 'BERHASIL OM',
			wrongFormat: 'FORMAT SALAH,COBA LIAT YANG BENER DI MENU OM',
			error: {
				stick: 'BUKAN STICKER ITU OM',
				Iv: 'LINKNYA EMROR OM'
			},
			only: {
				group: 'KHUSUS GRUP OM',
			}
		}
		const isUrl = (url) => {
...
*Model* : ${i.phone.device_model}\n\n`
    ...
    case 'm':
    case 'xiga':
    	var menu = `𝐇𝐀𝐋𝐋𝐎 𝐊𝐀𝐊 ${pushname}
    	
Prefix : 「 MULTI PREFIX OM」
...
│
╰┈┈┈─────────────┤`
menu2 = `*©𝑪𝒐𝒑𝒚𝒓𝒊𝒈𝒉𝒕 𝑩𝒚 𝑋𝑖𝑔𝑎ʹさ*\nAuthor: Hexa\nWM🗿:RYUU`
// JAN HAPUS WM KATA RYUU🗿
// KASIH WA XIGA JUGA LAH OM🗿
but = [
{ buttonId: `#info`, buttonText: { displayText: '️𝙸𝙽𝙶𝙵𝙾' }, type: 1 },
{ buttonId: `#owner`, buttonText: { displayText: '𝙾𝚆𝙽𝙴𝚁' }, type: 1 },
{ buttonId: `#scbot`, buttonText: { displayText: '𝚂𝙲𝚁𝙸𝙿𝚃' }, type: 1 }
]
